var lang = {
  ...
  "english": {
    "hero": "You want to find new people to play with? Huge servers are too chaotic for you? Then visit the Allrounder Clan. Everybody is welcome!",
    "discord_card": "You are new here? Then join the Discord server and introduce yourself. Play with many others any kind of games. Everybody is welcome!",
    "instagram_card": "Check out our Instagram page. See the latest clips of AR members and much more.",
    "allcraft": "AllCraft goes into the next round! Everyone from the Discord server is invited. Sign up today via the Discord server, and add yourself to the whitelist."
  }
}
